      ...
      <div class="lg:col-span-4">
        <div class="bg-surface-container-low p-10 sticky top-32">
          ...
          <div class="space-y-6">
            ...
            <button  class="w-full bg-primary text-on-primary py-5 font-label-sm text-label-sm tracking-[0.2em] uppercase hover:opacity-90 transition-opacity flex items-center justify-center gap-3">
              Pay Invoice
